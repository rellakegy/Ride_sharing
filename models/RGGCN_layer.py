...
class BatchNormNode(nn.Module):
    """Layer normalization for node features (replacing BatchNorm1d)."""
    ...
    def forward(self, x):
        ...
        Args:
            x: Node features (batch_size, num_nodes, hidden_dim)
        Returns:
            x_ln: Node features after layer normalization (batch_size, num_nodes, hidden_dim)
        """
...
class BatchNormEdge(nn.Module):
    """Layer normalization for edge features (replacing BatchNorm2d)."""
    ...
    def forward(self, e):
        ...
        Args:
            e: Edge features (batch_size, num_nodes, num_nodes, hidden_dim)
        Returns:
            e_ln: Edge features after layer normalization (batch_size, num_nodes, num_nodes, hidden_dim)
        """
        e_ln = self.layer_norm(e)
        return e_ln
